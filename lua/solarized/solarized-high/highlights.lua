...
function M.load_syntax()
	...
	elseif g.solarized_visibility == 'low' then
		...
		syntax['SpellBad'] = {fg=colors.violet,bg=colors.none,guisp=colors.orange,style='undercurl'}
		syntax['SpellCap'] = {fg=colors.violet,bg=colors.none,guisp=colors.orange,style='undercurl'}
