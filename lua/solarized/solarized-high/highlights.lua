...
function M.load_syntax()
	...
	if g.solarized_visibility == 'high' then
		...
		syntax['Title'] = {fg=colors.yellow,bg=colors.none,style='bold'}
	elseif g.solarized_visibility == 'low' then
		...
		syntax['SpellBad'] = {fg=colors.violet,bg=colors.none,guisp=colors.orange,style='underline'}
		syntax['SpellCap'] = {fg=colors.violet,bg=colors.none,guisp=colors.orange,style='underline'}
		...
		syntax['Title'] = {fg=colors.base01,bg=colors.none,style='bold'}
	else
	...
	syntax['Comment'] = {fg=colors.base00,bg=colors.none,style=utils.italics()}
