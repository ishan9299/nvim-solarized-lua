...
function M.load_syntax()
	...
	local syntax = {}
	syntax['Normal'] = {guifg=colors.base0,guibg=termtrans(colors.base03),gui='none',cterm='none'}
	syntax['CursorLine'] = {guifg='none',guibg=termtrans(colors.base02),gui='none',cterm='none'}
	...
	if g.solarized_visibility == 'high' then
		syntax['CursorLineNr'] = {guifg=colors.orange,guibg='none',gui='bold',cterm='bold'}
		...
		syntax['SpellBad'] = {guifg=colors.violet,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl',cterm=reverse,underline}
		syntax['SpellCap'] = {guifg=colors.violet,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl',cterm=reverse,underline}
		syntax['SpellLocal'] = {guifg=colors.yellow,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl',cterm=reverse,underline}
		syntax['SpellRare'] = {guifg=colors.cyan,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl',cterm=reverse,underline}
		syntax['Title'] = {guifg=colors.yellow,guibg='none',gui='bold',cterm='bold'}
	elseif g.solarized_visibility == 'low' then
		syntax['CursorLineNr'] = {guifg=colors.base01,guibg='none',gui='bold',cterm='bold'}
		...
		syntax['SpellBad'] = {guifg=colors.violet,guibg='none',guisp=colors.violet,gui='undercurl',cterm=underline}
		syntax['SpellCap'] = {guifg=colors.violet,guibg='none',guisp=colors.violet,gui='undercurl',cterm=underline}
		...
		syntax['CursorLineNr'] = {guifg=colors.base0,guibg='none',gui='bold',cterm='bold'}
	...
	if g.solarized_statusline == 'low' then
		syntax['StatusLine'] = {guifg=colors.base02,guibg=colors.base1,gui='bold,reverse',cterm='bold,reverse'}
	...
	syntax['FoldColumn'] = {guifg=colors.base0,guibg='none',gui='none',cterm='none'}
	syntax['Folded'] = {guifg=colors.base0,guibg='none',guisp=colors.base03,gui='bold',cterm='bold'}
	syntax['IncSearch'] = {guifg=colors.orange,guibg='none',gui='standout',cterm='standout'}
	syntax['LineNr'] = {guifg=colors.base01,guibg='none',gui='none',cterm='none'}
	...
	syntax['Pmenu'] = {guifg=colors.base0,guibg=colors.base02,gui='none',cterm='none'}
	syntax['PmenuSbar'] = {guifg='none',guibg=colors.base02,gui='none',cterm='none'}
	syntax['PmenuSel'] = {guifg=colors.base2,guibg=colors.base01,gui='none',cterm='none'}
	...
	syntax['Comment'] = {guifg=colors.base01,guibg='none',gui=italics(),cterm=italics()}
	...
	syntax['InsertMode'] = {guifg=colors.base02,guibg=colors.cyan,gui='bold,reverse',cterm='bold,reverse'}
	syntax['ReplaceMode'] = {guifg=colors.base02,guibg=colors.orange,gui='bold,reverse',cterm='bold,reverse'}
	syntax['VisualMode'] = {guifg=colors.base02,guibg=colors.magenta,gui='bold,reverse',cterm='bold,reverse'}
	syntax['CommandMode'] = {guifg=colors.base02,guibg=colors.magenta,gui='bold,reverse',cterm='bold,reverse'}
