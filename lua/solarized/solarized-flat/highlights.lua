...
function M.load_syntax()
	...
	if g.solarized_visibility == 'high' then
		syntax['CursorLineNr'] = {guifg=colors.orange,guibg='none',gui='bold'}
		syntax['NonText'] = {guifg=colors.orange,guibg='none',gui='bold'}
		syntax['SpecialKey'] = {guifg=colors.orange,guibg='none',gui='reverse'}
		syntax['SpellBad'] = {guifg=colors.violet,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellCap'] = {guifg=colors.violet,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellLocal'] = {guifg=colors.yellow,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellRare'] = {guifg=colors.cyan,guibg=colors.base2,guisp=colors.red,gui='reverse,undercurl'}
