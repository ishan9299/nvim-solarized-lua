...
function M.load_syntax()
	...
	if  g.solarized_visibility == 'high' then
		syntax['CursorLineNr'] = {fg=colors.red,bg=utils.termtrans(colors.base02),style='bold'}
	...
	if g.solarized_statusline == 'low' then
		...
		syntax['VertSplit'] = {fg=colors.base01,bg=colors.base1}
	...
	elseif g.solarized_statusline == 'flat' then
		...
		syntax['VertSplit'] = {fg=colors.base1,bg=colors.base3}
	...
	syntax['CursorLine'] = {fg=colors.none,bg=colors.none,guisp=colors.base0,style='underline',ctermfg=colors.none,ctermbg=colors.none}
	...
	syntax['SignColumn'] = {fg=colors.base00,bg=colors.none}
	...
	syntax['Comment'] = {fg=colors.base1,bg=colors.none,style=utils.italics()}
	...
	syntax['helpExample'] = {fg=colors.base01,bg=colors.none}
	...
	syntax['vimIsCommand'] = {fg=colors.base0,bg=colors.none}
	...
	syntax['gitcommitComment'] = {fg=colors.base1,bg=colors.none,style=utils.italics()}
	...
	syntax['perlHereDoc'] = {fg=colors.base1,bg=colors.base02}
	syntax['perlVarPlain'] = {fg=colors.yellow,bg=colors.base02}
	syntax['perlStatementFileDesc'] = {fg=colors.cyan,bg=colors.base02}
	syntax['texstatement'] = {fg=colors.cyan,bg=colors.base02}
	syntax['texmathzonex'] = {fg=colors.yellow,bg=colors.base02}
	syntax['texmathmatcher'] = {fg=colors.yellow,bg=colors.base02}
	syntax['texreflabel'] = {fg=colors.yellow,bg=colors.base02}
	syntax['rubyDefine'] = {fg=colors.base1,bg=colors.base02,style='bold'}
	syntax['rubyBoolean'] = {fg=colors.magenta,bg=colors.base02}
